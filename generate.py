...
SYSTEMS = [
    ...
    {
        "id": "timetruth", "emoji": "📊", "brand": "TimeTruth",
        "accent": "#4f7cff", "accent2": "#34d399", "bg": "#0a0e17", "bg_soft": "#111726",
        "repo_path": "/Users/Avishai/Developer/TimeTruth/frontend/public/landing.html", "shared_host": False,
        "title": "TimeTruth — ביצועי עובדים ותשלומים, סביב הזמנה אחת",
        "meta_desc": "TimeTruth מחברת הערכת עובדים רב-צירית ומעקב תשלומי חשבוניות סביב ההזמנה — כדי שתדעו מי מצטיין, איפה נתקע כסף, ומה עושים עם זה.",
        "badge": "ביצועים ותשלומים סביב ההזמנה · מבית PandaTech",
        "kicker": "האמת על הזמן, הערך והתשלום — במקום אחד",
        "h1": 'ביצועי עובדים ותשלומים,<br /><span class="grad">סביב הזמנה אחת</span>',
        "lead": "TimeTruth מרכזת שני עולמות שתמיד היו נפרדים — כמה טוב העובדים מבצעים וכמה מהר הכסף נכנס — סביב עמוד השדרה של העסק: ההזמנה. ציון ביצועים רב-צירי לכל עובד, ומעקב חי אחרי כל חשבונית עד התשלום.",
        "cta1": "לשמוע עוד →", "cta2": "מה המערכת עושה",
        "stats": [("5 צירי הערכה", "שעות · תקציב · לקוח · מקצועי · חברתי"), ("סביב ההזמנה", "עובדים, תקציב וחשבוניות במקום אחד"), ("חי ומאובטח", "הרשאות פר-תפקיד ופר-אתר")],
        "feat_h": "מה TimeTruth עושה", "feat_sub": "מהערכה סובייקטיבית ומעקב תשלומים ידני — לתמונה אחת, מדידה.",
        "features": [
            ("chart", "ציון ביצועים רב-צירי", "כל עובד מקבל ציון משוקלל מחמישה צירים — שעות מול תקן, ניצול תקציב, חוות דעת לקוח, וחוות דעת מקצועית וחברתית."),
            ("target", "ניצול תקציב לפי הזמנה", "עוקבים אחרי הקצב מול המכסה התקופתית — גם תת-ניצול וגם חריגה נגרעים מהציון, בלי קשר לסוג התקציב."),
            ("file", "מעקב חשבוניות עד תשלום", "כל חשבונית נקלטת ומקבלת סטטוס חי — הופקה, באישור, אושרה, שולמה או בפיגור — נגזר אוטומטית משרשרת האישורים."),
            ("trace", "איתור צווארי בקבוק", "המערכת מזהה מי מעכב אישורים ואיפה כסף נתקע, לפי ההמתנה התוספתית בין שלב לשלב — לא סתם מאשימה את השלב האחרון."),
            ("activity", "המלצות מבוססות-דפוס", "המלצות פעולה שנבנות מעל ההיסטוריה שלכם — לתגמל מצטיין, לנטר או להתערב — כולל עלות המימון של פיגורי תשלום."),
            ("lock", "הרשאות פר-תפקיד ופר-אתר", "מנהל, כספים, הנהלה ומנהל אתר — כל אחד רואה בדיוק את מה שמותר לו, כולל הפרדת נתונים רגישים."),
        ],
        "ben_h": "למה זה עובד", "ben_sub": "החלטות על אנשים וכסף — על נתונים, לא על תחושות.",
        "benefits": [
            ("תמונה אחת.", "ביצועים ותשלומים סביב אותה הזמנה."),
            ("אובייקטיבי.", "ציון עובד מחמישה צירים מדידים."),
            ("כסף בזמן.", "רואים כל חשבונית עד שהיא משולמת."),
            ("שם הצוואר.", "יודעים מי מעכב אישור ואיפה נתקע."),
            ("פעולה ברורה.", "כל ציון מתורגם להמלצה: לתגמל, לנטר או להתערב."),
            ("מאובטח.", "כל תפקיד רואה רק את שלו."),
        ],
        "form_h": "רוצים לראות את זה על העסק שלכם?", "form_sub": "השאירו פרטים ונחזור אליכם עם הדגמה.",
        "footer": "© TimeTruth · ביצועים ותשלומים סביב ההזמנה · מבית PandaTech",
    },
    {
        "id": "pandasales", "emoji": "📈", "brand": "PandaSales",
        "accent": "#10b981", "accent2": "#22d3ee", "bg": "#08121a", "bg_soft": "#0d1a26",
        "repo_path": "/Users/Avishai/Developer/Pandasales/pandasales/app/static/landing.html", "shared_host": False,
        "title": "PandaSales — מנוע פיתוח עסקי שמוצא לך שווקים חדשים",
        "meta_desc": "PandaSales הוא מנוע פיתוח עסקי מבוסס AI: מזהה שווקים והזדמנויות חדשים, מנקד אותם לפי התאמה ופוטנציאל, וגוזר מהם פתרון מלא ופנייה יזומה — מקצה לקצה.",
        "badge": "פיתוח עסקי מבוסס AI · מבית PandaTech",
        "kicker": "צמיחה לתחומים חדשים — בלי לנחש",
        "h1": 'הזדמנויות עסקיות חדשות,<br /><span class="grad">מזוהות ומנוקדות אוטומטית</span>',
        "lead": "PandaSales מאזין לאיתותי ביקוש בשוק, מזהה שווקים והזדמנויות חדשים, מנקד כל אחד לפי התאמה ופוטנציאל-התרחבות, וגוזר מההזדמנות פתרון מלא ופנייה יזומה — עם אישור אנושי לפני כל יציאה.",
        "cta1": "לשמוע עוד →", "cta2": "מה המערכת עושה",
        "stats": [("צמיחה לתחומים חדשים", "לא רק העמקה בקיים"), ("ניקוד תלת-צירי", "התאמה · איוש · התרחבות"), ("מקצה לקצה", "מהזדמנות ועד פנייה")],
        "feat_h": "מה PandaSales עושה", "feat_sub": "מאיתות ביקוש ועד פתרון ופנייה — במסלול אחד.",
        "features": [
            ("activity", "האזנה לאיתותי ביקוש", "מכרזים, גיוסים וחדשות ממקורות פומביים — מזהה מי צריך אותך עכשיו."),
            ("target", "ניקוד הזדמנויות תלת-צירי", "כל הזדמנות מדורגת לפי התאמה, יכולת איוש וערך-התרחבות לתחום חדש."),
            ("map", "גילוי שווקים חדשים", "מתחיל מהיכולות שלך ומזהה סקטורים שלמים שעדיין לא פנית אליהם."),
            ("spark", "גזירת פתרון מלא", "מסיכום פגישה — או ממערכת קיימת שכבר פיתחת — לפתרון ממוקד: מתודולוגיה, כלים, וצוות."),
            ("users", "לקוחות דומים", "מזהה ארגונים דומים ללקוחות הקיימים שלך ומרחיב את הצינור."),
            ("route", "פנייה יזומה מתוזמרת", "כל הזדמנות מוכשרת עוברת לפנייה חכמה — עם אישור אנושי לפני כל יציאה."),
        ],
        "ben_h": "למה זה עובד", "ben_sub": "החלטות על בסיס נתונים, מקצה לקצה, בשליטה מלאה.",
        "benefits": [
            ("צמיחה ממוקדת.", "מתרחב לתחומים חדשים, לא רק מעמיק בקיים."),
            ("בלי לנחש.", "החלטות על בסיס איתותים אמיתיים וניקוד."),
            ("מקצה לקצה.", "מהזדמנות ועד פתרון ופנייה — במקום אחד."),
            ("פתרון מוכן.", "כל הזדמנות נגזרת לפתרון עם צוות ותמחור."),
            ("אישור אנושי.", "שום פנייה לא יוצאת בלי שאדם אישר."),
            ("מתחבר לכלים שלך.", "CRM, מאגר המועמדים וערוץ הפנייה — במסלול אחד."),
        ],
        "form_h": "רוצים לשמוע עוד?", "form_sub": "השאירו פרטים ונחזור אליכם עם הדגמה.",
        "footer": "© PandaSales · פיתוח עסקי מבוסס AI · מבית PandaTech",
    },
    {
        "id": "pandapower", "emoji": "⚡", "brand": "PandaPower",
        "accent": "#6366f1", "accent2": "#22d3ee", "bg": "#0a0e1a", "bg_soft": "#111629",
        "repo_path": "/Users/Avishai/Developer/PandaPower/apps/frontend/public/landing.html", "shared_host": False,
        "title": "PandaPower — צוות גיוס מבוסס AI שעובד בשבילך בוואטסאפ",
        "meta_desc": "PandaPower הוא צוות סוכני AI שמנהלים גיוס מקצה לקצה בוואטסאפ: מזהים מועמדים מתאימים במאגר, פונים אליהם בשיחה אנושית בעברית, מסננים ומעבירים הלאה — סביב השעון, בכבוד לשעות הפעילות ולחגי ישראל.",
        "badge": "גיוס מבוסס AI בוואטסאפ · מבית PandaTech",
        "kicker": "הגיוס קורה בשיחה — תנו ל-AI לנהל אותה",
        "h1": 'צוות גיוס מבוסס AI,<br /><span class="grad">שעובד בשבילך בוואטסאפ</span>',
        "lead": "PandaPower הוא צוות סוכני AI שמנהלים את הגיוס מקצה לקצה: מזהים מי מהמאגר מתאים למשרה פתוחה, פותחים שיחה אנושית בעברית בוואטסאפ, מנהלים סינון ראשוני, ומעבירים את המתאימים הלאה בצוות — בלי לאבד אף פנייה, ובכבוד לזמן של המועמד.",
        "cta1": "לשמוע עוד →", "cta2": "מה המערכת עושה",
        "stats": [("שיחה אנושית בעברית", "פנייה בשם הפרטי, זיהוי מגדר נכון"), ("מקצה לקצה", "מהתאמה ועד סינון והעברה"), ("בכבוד לזמן", "שעות פעילות + חגי ישראל")],
        "feat_h": "מה PandaPower עושה", "feat_sub": "ממאגר מועמדים סטטי — לצוות גיוס פעיל שמדבר, מסנן ומתאם.",
        "features": [
            ("bubble", "סוכני וואטסאפ שמנהלים שיחה", "כל סוכן מנהל שיחת גיוס אמיתית בעברית — פונה למועמד בשמו הפרטי, מזהה מגדר נכון, ועונה לשאלות בטבעיות. כשמבקשים אדם — הוא מעביר לגורם אנושי."),
            ("target", "התאמת מועמד-משרה חכמה", "מנוע AI מדרג לכל משרה את המועמדים המתאימים ביותר מהמאגר, עם נימוק, חוזקות ופערים — כדי שהפנייה תצא רק למי שבאמת רלוונטי."),
            ("file", "קליטת קורות חיים אוטומטית", "קורות חיים שמגיעים במייל או בוואטסאפ נקלטים, מנותחים ונכנסים למאגר אוטומטית — בעברית ובאנגלית — בלי הקלדה ידנית."),
            ("route", "העברת שרביט בין סוכנים", "סוכן שמסיים שלב מעביר את המועמד הלאה בצוות — מסינון ראשוני ועד ליווי בהמשך התהליך — בלי שאף מועמד ייפול בין הכיסאות."),
            ("users", "טיפול אנושי כשצריך", "מועמד שמבקש לדבר עם אדם, או שדורש תשומת לב מיוחדת, עובר אוטומטית לצוות עם התראה — כך שאנשים מטפלים באנשים, ו-AI בשגרה."),
            ("calendar", "מכבד שעות פעילות וחגי ישראל", "הסוכנים פונים רק בשעות ובימים מקובלים, ונחים בשבתות ובחגי ישראל (כולל מערב החג) — נימוס שמייצר יחס אנושי ומגן על המוניטין."),
        ],
        "ben_h": "למה זה עובד", "ben_sub": "גיוס מהיר יותר, אנושי יותר — בלי לוותר על שליטה.",
        "benefits": [
            ("מהיר.", "פנייה למועמדים מתאימים תוך דקות, לא ימים."),
            ("אנושי.", "שיחה בעברית, בשם הפרטי, בזמן הנכון."),
            ("מדויק.", "פונים רק למי שהתאמת ה-AI סימנה כרלוונטי."),
            ("שום פנייה לא נופלת.", "כל מועמד ממשיך לשלב הבא בצוות."),
            ("בכבוד.", "שקט בשבת ובחג — מכבד את המועמד ואת המותג."),
            ("בשליטה.", "אדם נכנס לתמונה בכל רגע שצריך."),
        ],
        "form_h": "רוצים לראות את זה על הגיוס שלכם?", "form_sub": "השאירו פרטים ונחזור אליכם עם הדגמה.",
        "footer": "© PandaPower · גיוס מבוסס AI בוואטסאפ · מבית PandaTech",
    },
]
